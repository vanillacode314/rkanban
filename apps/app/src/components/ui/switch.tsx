...
type SwitchThumbProps = { class?: string | undefined } & SwitchPrimitive.SwitchThumbProps;
...
type SwitchLabelProps = { class?: string | undefined } & SwitchPrimitive.SwitchLabelProps;
